...
// --------------------------------------------------------------------------------------------
/*static */ 
TextCode CStdioFileEx::GetFileType(LPCTSTR lpszFileName)
{
	CFile file;
...
CString CStdioFileEx::FileTypeToString()
{
	...
	{
	case ANSI:
		strtype.Format(_T("%s"), _T("ANSI"));
		break;
	case UTF8:
		strtype.Format(_T("%s"), _T("UTF8"));
		break;
	case UNICOD:
		strtype.Format(_T("%s"), _T("UNICODE"));
		break;
	case UNICODBIGENDIAN:
		strtype.Format(_T("%s"), _T("UNICODE big endian"));
		break;
	case FILEERROR:
		strtype.Format(_T("%s"), _T("FILEERROR"));
		break;
	default:
		break;
	}
